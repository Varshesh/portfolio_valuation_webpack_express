            ...
            return (
                <React.Fragment key={index}>
                    <div className="row list-row collapsed" data-toggle="collapse" data-target={".security_" + index} aria-expanded="false" >
                        ...
                        <div className="col-2">{Commom.formatDate(obj.data[0].date)}</div>
                        <div className="col-2">{obj.data[0].shares}</div>
                        <div className="col-2">{obj.data[0].price}</div>
                        <div className="col-2">{obj.data[0].amount}</div>
                    </div>
